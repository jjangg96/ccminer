...
USER $APP_USER
COPY . $BUILD_FOLDER/ccminer/
USER root
# RUN cd $BUILD_FOLDER && git clone https://github.com/jjangg96/ccminer.git --branch $CCMINER_VERSION --single-branch
...
#COPY src/build.sh $CCMINER_FOLDER
